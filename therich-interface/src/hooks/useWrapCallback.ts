import { Currency, currencyEquals, DEV, WDEV } from 'richsdk'
          ...
          sufficientBalance && inputAmount
            ? async () => {
                try {
                  ...
                  addTransaction(txReceipt, { summary: `Wrap ${inputAmount.toSignificant(4)} DEV to WDEV` })
                } catch (error) {
          ...
          sufficientBalance && inputAmount
            ? async () => {
                try {
                  ...
                  addTransaction(txReceipt, { summary: `Unwrap ${inputAmount.toSignificant(4)} WDEV to ETH` })
                } catch (error) {

import { Currency, CurrencyAmount, DEV, JSBI, Token, TokenAmount } from 'richsdk'
...
export function useCurrencyBalance(account?: string, currency?: Currency): CurrencyAmount | undefined | any {
